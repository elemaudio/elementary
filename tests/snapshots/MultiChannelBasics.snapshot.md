...
flowchart TD
    ...
    n0x31bc2e98["0x31bc2e98<br/>root<br/>_internal:numChildren=1.0<br/>active=true<br/>channel=1.0<br/>fadeInMs=20.0<br/>fadeOutMs=20.0"]
